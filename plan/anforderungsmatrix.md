...
| REQ-004 | Parameter schreiben, nur reverse-engineerte Adressen ([Ziel](../reference/ziel.md#2-was-aus-biketunes-übernommen-werden-soll)) | V1 | Ja | T013, T016, T030-T036 | Fake-Write-, ACK-, HEB-, Read-back- und Rollback-Tests | 2, 5 | Reale Writes bis bestaetigte Fixtures deaktiviert |
...
| REQ-025 | Harte Grenzen fuer MaxLineCurr/MaxPhaseCurr ([Ziel](../reference/ziel.md#34-sicherheitsregeln-beim-schreiben-von-parametern)) | V1 | Ja | T030-T032 | Boundary- und unbekannter-Hardware-Tests | 5 | Limits `BLOCKIERT`, bis Hardwareprofil bestaetigt |
...
| REQ-038 | Defensive Programmierung beim Schreiben ([Ziel](../reference/ziel.md#6-technische-leitplanken)) | V1 | Ja | T030-T036 | Fuzz-/Fehlerpfad- und Coverage-Tests | 5 | - |
