...
- [~] **T001** Anforderungs-Traceability erstellen ([Details](./00-ausfuehrungsregeln.md#t001---anforderungs-traceability-erstellen))
...
- [ ] **T004** Flutter-, Dart-, Docker- und Android-Versionen festlegen ([Details](./01-grundlage-und-build.md#t004---toolchain-reproduzierbar-festlegen))
- [ ] **T005** Android-Gradle-Konfiguration reparieren ([Details](./01-grundlage-und-build.md#t005---android-gradle-konfiguration-reparieren))
- [ ] **T006** BikeTunes vollstaendig zu ArcDash umbenennen ([Details](./01-grundlage-und-build.md#t006---projekt-zu-arcdash-umbenennen))
...
- [ ] **T024** Versionierte Persistenzarchitektur festlegen ([Details](./04-backup-und-snapshots.md#t024---versionierte-persistenzarchitektur-festlegen))
...
- [ ] **T035** Teilfehler und Rollback behandeln ([Details](./05-sichere-schreibengine.md#t035---teilfehler-und-rollback-behandeln))
- [ ] **T036** Write-Lock, Idempotenz und Audit-Log ergaenzen ([Details](./05-sichere-schreibengine.md#t036---write-lock-idempotenz-und-audit-log-ergaenzen))
